export const ExpertsSection = () => {
  return (
    <div className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] break-words w-full">
      <div className="relative bg-red-100 box-border caret-transparent max-w-none min-h-[360px] min-w-[auto] break-words w-full overflow-hidden py-5 rounded-[17px] md:max-w-[1400px] md:min-h-[700px] md:py-[100px] md:rounded-[33px]">
          ...
          <div className="relative box-border caret-transparent list-none break-words z-[1] overflow-hidden mx-auto">
            <div className="relative caret-transparent flex h-full break-words translate-x-[-514.222px] w-full z-[1] md:translate-x-[-1117.8px]">
              <div className="relative box-border caret-transparent shrink-0 h-full min-h-[auto] min-w-[auto] break-words w-[182.778px] mr-[15px] md:w-[466.8px] md:mr-[30px]">
                <a
                  href="https://youtu.be/D8mxrSvCZ1M?si=Zr7pi0QqvmHdGUw0"
              ...
              <div className="relative box-border caret-transparent shrink-0 h-full min-h-[auto] min-w-[auto] break-words w-[182.778px] mr-[15px] md:w-[466.8px] md:mr-[30px]">
                <a
                  href="https://youtu.be/CND-OpobQt0?si=WZjjBorSfbz4wFVG"
                  className="box-border caret-transparent break-words"
                >
                  <div className="box-border caret-transparent break-words">
                    <div className="box-border caret-transparent inline-block break-words w-full overflow-hidden rounded-[10px] md:rounded-[30px]">
              ...
              <div className="relative box-border caret-transparent shrink-0 h-full min-h-[auto] min-w-[auto] break-words w-[182.778px] mr-[15px] md:w-[466.8px] md:mr-[30px]">
                <a
                  href="https://youtu.be/iJG0GB9VZks?si=xmOpp6DjNeeCj7M7"
                  className="box-border caret-transparent break-words"
                >
                  <div className="box-border caret-transparent break-words">
                    <div className="box-border caret-transparent inline-block break-words w-full overflow-hidden rounded-[10px] md:rounded-[30px]">
              ...
              <div className="relative box-border caret-transparent shrink-0 h-full min-h-[auto] min-w-[auto] break-words w-[182.778px] mr-[15px] md:w-[466.8px] md:mr-[30px]">
                <a
                  href="https://youtu.be/ccDjysySykI?si=wV20-RogDkWTpMq_"
                  className="box-border caret-transparent break-words"
                >
                  <div className="box-border caret-transparent break-words">
                    <div className="box-border caret-transparent inline-block break-words w-full overflow-hidden rounded-[10px] md:rounded-[30px]">
              ...
              <div className="relative box-border caret-transparent shrink-0 h-full min-h-[auto] min-w-[auto] break-words w-[182.778px] mr-[15px] md:w-[466.8px] md:mr-[30px]">
                <a
                  href="https://youtu.be/nUESeu10nmM?si=zTD4z7y4xHYAJePU"
                  className="box-border caret-transparent break-words"
                >
                  <div className="box-border caret-transparent break-words">
                    <div className="box-border caret-transparent inline-block break-words w-full overflow-hidden rounded-[10px] md:rounded-[30px]">
