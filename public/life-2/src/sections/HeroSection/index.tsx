...
export const HeroSection = () => {
  ...
  return (
    <div id="hero" className="relative items-center box-border caret-transparent flex flex-col justify-center break-words px-0 md:px-[34px]">
      <div className="relative bg-[radial-gradient(circle,rgb(30,0,0)_0%,rgb(80,0,0)_40%,rgb(10,10,10)_100%)] box-border caret-transparent max-w-[2000px] min-h-[auto] min-w-[auto] break-words w-full overflow-hidden rounded-none md:rounded-[33px]">
        {/* 배경 오버레이 - 레드 글로우 */}
        ...
        <div className="absolute box-border caret-transparent h-full break-words w-full overflow-hidden left-0 top-0">
          <div className="absolute box-border caret-transparent h-[900px] ml-[-450px] mt-[-450px] break-words w-[900px] left-2/4 top-2/4 md:h-[1500px] md:ml-[-750px] md:mt-[-750px] md:w-[1500px]">
            <img
              ...
              className="aspect-[auto_1050_/_1050] box-border caret-transparent h-full max-w-full break-words align-baseline w-full opacity-10"
            />
          </div>
        </div>
        ...
        <div ref={heroRef} className="relative items-center box-border caret-transparent flex flex-col justify-center break-words">
          ...
          <h2 className="hero-reveal text-white text-[34px] font-bold box-border caret-transparent leading-[45.22px] min-h-[auto] min-w-[auto] break-words text-center mt-[50px] md:text-[68px] md:leading-[81.6px] md:mt-[70px]">
            클릭 한 번으로 끝내는
            <br className="text-[34px] box-border caret-transparent leading-[45.22px] break-words md:text-[68px] md:leading-[81.6px]" />
            <span className="text-red-500">프리미엄 렌트카</span>
          </h2>
