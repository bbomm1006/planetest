...
export const ReviewsSection = () => {
  ...
  return (
    <div className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] break-words w-full">
      <div className="relative bg-[#eef7ee] box-border caret-transparent max-w-none min-h-[auto] min-w-[auto] break-words w-full overflow-hidden pt-[28px] pb-[44px] rounded-[17px] md:max-w-[2000px] md:pt-[52px] md:pb-[64px] md:rounded-[33px]">
        <ReviewHeader />
