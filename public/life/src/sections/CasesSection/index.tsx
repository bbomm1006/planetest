...
const FAQ_DATA = [
  {
    question: "어떤 렌트카 서비스인가요?",
    answer: "레드존렌트카는 단기렌트, 장기렌트, 보험대차를 전문으로 하는 차량 렌트 서비스입니다. 다양한 차종과 합리적인 가격으로 고객님의 이동을 편리하게 도와드립니다.",
  },
  {
    question: "단기 렌트 외 다른 서비스도 있나요?",
    answer: "네, 가능합니다. 장기렌트, 월렌트, 보험대차, 공항 픽업 등 다양한 맞춤형 서비스를 제공하고 있습니다. 고객님의 상황에 맞춰 최적의 차량을 안내해드립니다.",
  },
  {
    question: "다른 업체보다 어떤 점이 좋나요?",
    answer: "다양한 차종 보유, 합리적인 요금, 철저한 차량 관리, 그리고 친절한 고객 응대로 높은 만족도를 제공합니다.",
  },
  {
    question: "단기렌트와 장기렌트는 뭐가 다른가요?",
    answer: "단기렌트는 하루~수일 단위로 차량을 이용하는 서비스이며, 장기렌트는 한 달 이상 장기간 이용하는 서비스입니다. 이용 기간과 목적에 맞게 선택하시면 됩니다.",
  },
  {
    question: "보험대차나 사고 대차도 가능한가요?",
    answer: "네, 가능합니다. 사고나 차량 정비로 차량 이용이 어려울 경우 보험대차 및 대차 서비스를 신속하게 지원해드립니다.",
  },
  {
    question: "차량 이용 중 문제가 생기면 어떻게 하나요?",
    answer: "이용 중 문제가 발생할 경우 즉시 고객센터로 연락주시면 신속하게 대응해드리며, 필요 시 대체 차량 지원 등 사후 서비스를 제공해드립니다.",
  },
];
...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <li className={`bg-red-100 box-border caret-transparent break-words rounded-[25px] overflow-hidden transition-all duration-300 md:rounded-[40px] ${open ? "bg-white shadow-[rgba(45,55,72,0.08)_0px_4px_20px_0px]" : ""}`}>
      <button
        type="button"
        aria-expanded={open}
        onClick={() => setOpen((v) => !v)}
    ...
    <div className="relative box-border caret-transparent shrink-0 h-full min-h-[auto] min-w-[auto] break-words w-[320px] md:w-[548px]">
      <div className="relative bg-white shadow-[rgba(45,55,72,0.05)_0px_0px_1px_0px,rgba(45,55,72,0.1)_0px_4px_8px_0px] box-border caret-transparent flex flex-col break-words mb-2.5 p-5 rounded-2xl aspect-square md:shadow-none md:mb-0 md:p-[40px]">
        ...
        <div className="box-border caret-transparent ml-[-3px] min-h-[auto] min-w-[auto] break-words mt-2.5 md:mt-[22px]">
          {review.tags.map((tag) => (
            <div key={tag} className="text-red-800 text-xs font-semibold bg-red-100 box-border caret-transparent inline-block leading-[18px] break-words m-[3px] px-2 py-px rounded-md md:text-sm md:leading-[21px]">
              {tag}
            </div>
          ))}
        </div>
    ...
    <div id="cases" className="box-border caret-transparent gap-x-[17px] flex flex-col break-words gap-y-[17px] p-[17px] md:gap-x-[34px] md:gap-y-[34px] md:p-[34px]">
      <RevealSection className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] break-words w-full">
        <div className="box-border caret-transparent max-w-none min-h-[360px] min-w-[auto] break-words w-full overflow-hidden py-[30px] rounded-[17px] md:max-w-[1400px] md:min-h-[700px] md:py-[110px] md:rounded-[33px]">
          <h2 className="text-[25px] font-bold box-border caret-transparent leading-[33.25px] break-words text-center mb-2 md:text-[50px] md:leading-[60px] md:mb-[15px] text-white">
            어떤 공간이든, 어떤 상황이든
      ...
      <RevealSection delay={100} className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] break-words w-full">
        <div className="relative box-border caret-transparent max-w-none min-h-[360px] min-w-[auto] break-words w-full overflow-hidden rounded-[17px] md:max-w-[1400px] md:min-h-[700px] md:rounded-[33px]">
          <div className="absolute items-center box-border caret-transparent flex h-full justify-center break-words w-full left-0 top-0 after:accent-auto after:bg-red-600/90 after:caret-transparent after:text-gray-900 after:block after:text-base after:not-italic after:normal-nums after:font-normal after:h-full after:tracking-[-0.64px] after:leading-6 after:list-outside after:list-disc after:break-words after:pointer-events-auto after:absolute after:text-start after:no-underline after:indent-[0px] after:normal-case after:visible after:w-full after:border-separate after:left-0 after:top-0 after:font-pretendard">
      ...
      <RevealSection delay={150} className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] break-words w-full">
        <div className="relative bg-red-100 box-border caret-transparent max-w-none min-h-[360px] min-w-[auto] break-words w-full overflow-hidden py-[30px] rounded-[17px] md:max-w-[1400px] md:min-h-[700px] md:py-[60px] md:rounded-[33px]">
          <div className="items-center box-border caret-transparent flex justify-center break-words mb-5 md:mb-[30px]">
            <div className="box-border caret-transparent gap-x-[5px] flex min-h-[auto] min-w-[auto] break-words gap-y-[5px] w-[87%] px-0 md:gap-x-2 md:gap-y-2 md:w-full md:px-[60px]">
              ...
              <div className="box-border caret-transparent basis-[0%] grow min-h-[auto] min-w-[auto] break-words">
                ...
                <p className="text-red-400 text-sm font-semibold box-border caret-transparent leading-[21px] break-words md:text-lg md:leading-[27px]">
                  고객님들의 리얼 후기로 확인해보세요.
                </p>
              </div>
              <a
              ...
              {[
                {
                  ...
                  title: "차 상태가 너무 좋아서 처음 받을 때 기분이 정말 좋았어요",
                  body: "처음에는 반신반의했는데 막상 결과를 보고 깜짝 놀랐어요. 구석구석 정말 꼼꼼하게 차량을 관리해주셔서 새 차처럼 느껴졌습니다. 특히 시간 약속도 칼같이 지켜주셔서 믿음이 갔어요. 가격 대비 퀄리티가 너무 좋아서 주변에도 추천하고 있습니다."
                },
                {
                  img: "128.png",
                  name: "김○○",
                  meta: "20대 / 남성 / 대학생",
                  tags: ["빠른 예약", "깔끔한 차량", "친절한 안내", "편한 진행"],
                  title: "렌트카 받아보고 기대 이상으로 만족했습니다",
                  body: "예약도 앱으로 간편하게 할 수 있어서 좋았고, 담당자분이 진행 과정을 친절하게 안내해주셔서 처음 이용했는데도 전혀 불편함이 없었어요. 차량 상태도 끝내주게 깔끔해서 기분이 좋았습니다."
                },
                {
                  img: "156.png",
                  name: "박○○",
                  meta: "30대 / 남성 / 자영업",
                  tags: ["빠른 작업", "전문적인 서비스", "체계적인 진행", "신뢰감"],
                  title: "업무용 차량 렌트도 전문가 느낌이 나네요",
                  body: "업무용 차량 렌트를 맡겼는데 작업 속도도 빠르고 체계적으로 진행해주셔서 업무 준비에 전혀 지장이 없었습니다. 일반 렌트카업체와는 확실히 다른 전문성이 느껴졌고, 손이 잘 닿지 않는 부분까지 꼼꼼하게 처리해주셔서 다음에도 꼭 이용할 예정입니다."
                },
                {
                  img: "133.png",
                  name: "최○○",
                  meta: "40대 / 여성 / 주부",
                  tags: ["세심한 관리", "합리적인 가격", "전문 장비", "깔끔한 결과"],
                  title: "차량 상태가 특히 만족스러웠어요",
                  body: "차량 내부 청결이 걱정됐는데 전문 장비로 말끔하게 관리해주셨어요. 일반 렌트카로는 절대 안 될 것 같았던 부분들도 다 깨끗하게 해주셔서 정말 감동받았습니다. 가격도 합리적이라 부담 없이 이용할 수 있었어요."
                },
                {
                  img: "124.png",
                  name: "정○○",
                  ...
                  title: "처음 렌트했는데 응대와 결과 모두 만족입니다",
                  body: "렌트카 서비스를 처음 이용했는데 상담부터 마무리까지 친절하게 안내해주셔서 편하게 진행할 수 있었어요. 정해진 시간에 정확히 도착하셔서 믿음이 갔고, 차량 상태도 완벽하게 관리되어 다음에도 꼭 이용할 것 같아요."
                },
                {
                  img: "145.png",
                  name: "이○○",
                  meta: "50대 / 남성 / 개인사업자",
                  tags: ["체계적인 서비스", "믿을 수 있는 업체", "확실한 결과", "높은 만족도"],
                  title: "다음에도 재이용할 생각입니다. 믿고 맡길 수 있네요",
                  body: "여러 렌트카 업체를 이용해봤는데 이렇게 체계적으로 운영하는 곳은 처음이었어요. 진행 상황을 중간중간 알려주시고 결과물도 확실해서 신뢰가 생겼습니다. 바쁜 업무 특성상 빠르고 정확한 서비스가 필요했는데 딱 맞게 해주셔서 정말 만족합니다."
                },
              ].map((review, i) => (
      ...
      <RevealSection delay={100} className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] break-words w-full">
        <div className="box-border caret-transparent flex flex-col max-w-none min-h-[360px] min-w-[auto] break-words w-full overflow-hidden p-5 rounded-[17px] md:flex-row md:max-w-[1400px] md:min-h-[700px] md:p-[100px] md:rounded-[33px]">
          <h2 className="static text-[25px] font-bold box-border caret-transparent leading-[33.25px] min-h-[auto] min-w-[auto] break-words text-center z-[2] mb-2 md:absolute md:text-[50px] md:leading-[60px] md:min-h-0 md:min-w-0 md:text-start md:mb-[15px] text-white">
            쉽고 빠르게 끝내는
          ...
          <div className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] break-words">
            <div className="relative box-border caret-transparent min-h-[auto] min-w-[auto] break-words w-auto overflow-hidden mt-[30px] md:w-[900px] md:mt-0 before:accent-auto before:bg-[linear-gradient(to_right,rgb(0,0,0),rgba(0,0,0,0))] before:caret-transparent before:text-gray-900 before:block before:text-base before:not-italic before:normal-nums before:font-normal before:tracking-[-0.64px] before:leading-6 before:list-outside before:list-disc before:break-words before:pointer-events-auto before:absolute before:text-start before:no-underline before:indent-[0px] before:normal-case before:visible before:w-[30px] before:z-[1] before:border-separate before:inset-y-0 before:font-pretendard before:md:w-[100px] after:accent-auto after:bg-[linear-gradient(to_left,rgb(0,0,0),rgba(0,0,0,0))] after:caret-transparent after:text-gray-900 after:block after:text-base after:not-italic after:normal-nums after:font-normal after:tracking-[-0.64px] after:leading-6 after:list-outside after:list-disc after:break-words after:pointer-events-auto after:absolute after:text-start after:no-underline after:indent-[0px] after:normal-case after:visible after:w-[30px] after:z-[1] after:border-separate after:right-0 after:inset-y-0 after:font-pretendard after:md:w-[100px]">
              <div className="animate-marquee flex gap-x-2.5 md:gap-x-[46px]" style={{width:"max-content"}}>
                {[
                  { img: "144.png", label: "렌트카 상세 안내서" },
                  { img: "person-running.0yi2wt8f7fvts.png", label: "렌트카용품 무상 제공" },
                  { img: "183.png", label: "렌트카 내역 온라인 관리" },
                  { img: "188.png", label: "맞춤 렌트카 진단" },
                  { img: "rocket.0tm7okw41dt6i.png", label: "당일 렌트카 완료" },
                  { img: "127.png", label: "진행상황 자동알림" },
                  { img: "147.png", label: "실시간 채팅상담" },
                  { img: "132.png", label: "렌트카 품질 컨설팅" },
                  ...
                  <div key={i} className="items-center bg-red-50 box-border caret-transparent gap-x-[15px] flex flex-col h-[120px] justify-center break-words gap-y-[15px] w-[120px] rounded-[20px] flex-shrink-0 hover:bg-red-100 transition-colors duration-200 md:gap-x-5 md:h-60 md:gap-y-5 md:w-60 md:rounded-[40px]">
      ...
      <RevealSection delay={100} className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] break-words w-full">
        <div className="relative bg-amber-200 box-border caret-transparent max-w-none min-h-[360px] min-w-[auto] break-words w-full overflow-hidden px-0 py-5 rounded-[17px] md:max-w-[1400px] md:min-h-[700px] md:p-[100px] md:rounded-[33px]">
          <div className="static text-red-800 box-border caret-transparent break-words my-5 md:absolute">
      ...
      <RevealSection delay={100} className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] break-words w-full">
        <div className="relative bg-white box-border caret-transparent max-w-none min-h-[360px] min-w-[auto] break-words w-full overflow-hidden pt-10 pb-5 px-5 rounded-[17px] md:max-w-[1400px] md:min-h-[700px] md:p-[100px] md:rounded-[33px]">
          <div className="static text-red-800 box-border caret-transparent break-words my-5 md:absolute">
            <h2 className="text-[25px] font-bold box-border caret-transparent leading-[33.25px] break-words text-center mb-2 md:text-[50px] md:leading-[60px] md:text-start md:mb-[15px]">
              전국 어디든 가능한 풍부한 렌트카 경험
            </h2>
      ...
      <RevealSection delay={100} className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] break-words w-full">
        <div className="relative bg-zinc-100 box-border caret-transparent max-w-none min-h-[360px] min-w-[auto] break-words w-full overflow-hidden pt-10 pb-5 px-5 rounded-[17px] md:max-w-[1400px] md:min-h-[700px] md:p-[100px] md:rounded-[33px]">
          ...
          <p className="text-[13px] font-semibold box-border caret-transparent leading-[19.5px] break-words text-center mt-2 md:text-xl md:leading-[30px] md:text-start md:mt-[15px]">
            안전하고 신뢰할 수 있는 렌트카 서비스로
            <br className="text-[13px] box-border caret-transparent leading-[19.5px] break-words text-center md:text-xl md:leading-[30px] md:text-start" />
            고객님의 이동을 가장 편리하게 만들어드립니다
          </p>
          <ul className="relative box-border caret-transparent gap-x-[13px] flex flex-col break-words gap-y-[13px] w-auto mt-[25px] pl-0 md:gap-x-[22px] md:gap-y-[22px] md:w-[400px] md:mt-[120px]">
            <li className="items-center bg-white shadow-[rgba(45,55,72,0.05)_0px_0px_1px_0px,rgba(45,55,72,0.1)_0px_8px_16px_0px] box-border caret-transparent gap-x-[15px] flex h-[70px] min-h-[auto] min-w-[auto] break-words gap-y-[15px] w-auto pl-[26px] rounded-xl md:shadow-[rgba(45,55,72,0.05)_0px_0px_1px_0px,rgba(45,55,72,0.1)_0px_16px_24px_0px] md:gap-x-6 md:h-[100px] md:gap-y-6 md:w-[500px] md:pl-[50px] md:rounded-[20px]">
              ...
              <p className="text-[17px] font-semibold box-border caret-transparent leading-[25.5px] min-h-[auto] min-w-[auto] break-words md:text-2xl md:leading-9">
                철저하게 확인하는 {" "}
                <span className="relative text-[17px] box-border caret-transparent leading-[25.5px] break-words md:text-2xl md:leading-9 after:accent-auto after:bg-red-300 after:caret-transparent after:text-gray-900 after:block after:text-[17px] after:not-italic after:normal-nums after:font-semibold after:h-1/5 after:tracking-[-0.64px] after:leading-[25.5px] after:list-outside after:list-disc after:break-words after:pointer-events-auto after:absolute after:text-start after:no-underline after:indent-[0px] after:normal-case after:visible after:border-separate after:bottom-0 after:inset-x-0 after:font-pretendard after:md:text-2xl after:md:leading-9">
                  <u className="relative text-red-400 text-[17px] box-border caret-transparent leading-[25.5px] break-words z-[1] md:text-2xl md:leading-9">
                    차량 점검 서비스
                  </u>
                </span>
              </p>
      ...
      <RevealSection delay={100} className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] break-words w-full">
        <div className="relative bg-stone-700 box-border caret-transparent max-w-none min-h-[360px] min-w-[auto] break-words w-full overflow-hidden py-5 rounded-[17px] md:max-w-[1400px] md:min-h-[700px] md:py-[100px] md:rounded-[33px]">
      ...
      <RevealSection delay={100} id="pricing" className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] break-words w-full">
        <div className="bg-red-100 box-border caret-transparent max-w-none min-h-[360px] min-w-[auto] break-words w-full overflow-hidden p-[25px] rounded-[17px] md:max-w-[1400px] md:min-h-[700px] md:p-[35px] md:rounded-[33px]">
            ...
            <div className="bg-white box-border caret-transparent flex basis-[0%] flex-col grow min-h-[auto] min-w-[auto] break-words p-[25px] rounded-[15px] md:flex-row md:p-[70px] md:rounded-[30px]">
              <div className="box-border caret-transparent min-h-[auto] min-w-[auto] break-words">
                <h2 className="text-[25px] font-bold box-border caret-transparent leading-[33.25px] break-words text-center mb-2 md:text-[50px] md:leading-[60px] md:text-start md:mb-[15px]">
                  생활에 부담되지 않도록,
                  <br className="text-[25px] box-border caret-transparent leading-[33.25px] break-words text-center md:text-[50px] md:leading-[60px] md:text-start" />
                  <span className="relative text-[25px] box-border caret-transparent leading-[33.25px] break-words text-center md:text-[50px] md:leading-[60px] md:text-start after:accent-auto after:bg-red-300 after:caret-transparent after:text-gray-900 after:block after:text-[25px] after:not-italic after:normal-nums after:font-bold after:h-1/5 after:tracking-[-0.64px] after:leading-[33.25px] after:list-outside after:list-disc after:break-words after:pointer-events-auto after:absolute after:text-center after:no-underline after:indent-[0px] after:normal-case after:visible after:border-separate after:bottom-0 after:inset-x-0 after:font-pretendard after:md:text-[50px] after:md:leading-[60px] after:md:text-start">
                    <u className="relative text-red-400 text-[25px] box-border caret-transparent leading-[33.25px] break-words text-center z-[1] md:text-[50px] md:leading-[60px] md:text-start">
                      업계 유일
                    </u>
                  </span>
                  장기 분할납부제
      ...
      <TeamCarouselSection />
      <RevealSection delay={100} className="items-center box-border caret-transparent flex justify-center min-h-[auto] min-w-[auto] break-words w-full">
        <div className="relative items-center bg-[radial-gradient(circle,rgb(20,20,20)_40%,rgb(80,0,0)_100%)] shadow-[rgba(220,38,38,0.3)_0px_0px_30px_0px_inset] box-border caret-transparent flex justify-center max-w-none min-h-[360px] min-w-[auto] break-words w-full overflow-hidden rounded-[17px] md:shadow-[rgba(220,38,38,0.3)_0px_0px_110px_0px_inset] md:max-w-[1400px] md:min-h-[700px] md:rounded-[33px]">
          <div className="absolute box-border caret-transparent h-full break-words w-full overflow-hidden left-0 top-0">
            <div className="absolute box-border caret-transparent h-[800px] ml-[-400px] mt-[-400px] break-words w-[800px] left-2/4 top-2/4 md:h-[2000px] md:ml-[-1000px] md:mt-[-1000px] md:w-[2000px]">
              <img
                ...
                className="aspect-[auto_1400_/_1400] box-border caret-transparent h-full max-w-full break-words align-baseline w-full opacity-10"
              />
            </div>
          </div>
          <div className="box-border caret-transparent min-h-[auto] min-w-[auto] break-words relative z-10">
            <p className="text-white text-[21px] font-bold box-border caret-transparent leading-[31.5px] break-words text-center md:text-[44px] md:leading-[66px]">
              지금 바로 원하는 차를 예약하세요
            </p>
            ...
            <div className="items-center box-border caret-transparent flex justify-center break-words">
              <a href="/product" className="box-border caret-transparent block min-h-[auto] min-w-[auto] break-words">
                <button
                  type="button"
                  className="btn-press relative appearance-none text-white text-lg font-semibold items-center bg-red-600 hover:bg-red-700 shadow-[rgba(220,38,38,0.4)_0px_10px_15px_0px] caret-transparent inline-flex h-[60px] justify-center leading-[21.6px] min-w-[60px] outline-transparent outline-offset-2 outline outline-2 break-words text-center text-nowrap align-middle mt-[15px] px-7 py-0 rounded-full transition-colors md:text-3xl md:shadow-[rgba(220,38,38,0.4)_0px_15px_20px_0px] md:h-20 md:leading-9 md:min-w-0 md:mt-[30px] md:px-10"
                >
                  차량 둘러보기
                </button>
              </a>
      ...
      <RevealSection delay={100} className="items-center box-border caret-transparent flex flex-col justify-center min-h-[auto] min-w-[auto] break-words py-[60px] md:py-[150px]">
        <h2 className="text-[25px] font-bold box-border caret-transparent leading-[33.25px] min-h-[auto] min-w-[auto] break-words text-center mb-2 md:text-[50px] md:leading-[60px] md:text-start md:mb-[15px] text-white">
          혹시 이것도 궁금하세요?
        </h2>
