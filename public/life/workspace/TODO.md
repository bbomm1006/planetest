...
<todo id="seo-meta">
Add SEO meta tags
Add og:title, og:description, og:image, lang="ko" to index.html for Korean search visibility
</todo>

<todo id="page-loading-skeleton">
Loading skeleton / performance
Add a skeleton loader or lazy-load off-screen sections to improve initial load time for the many images
</todo>
