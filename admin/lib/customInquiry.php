  ...
  <div class="card">
    <div class="card-body">
      <div class="form-group" style="margin-bottom:16px;">
        <label>폼 제목 <span style="color:#e53e3e;">*</span></label>
...
<div class="page" id="page-customInquiryList">
  ...
  <div class="card">
    <div class="card-body" style="padding:0;">
      <table class="data-table" id="ciFormTable">
        <thead>
          <tr>
            <th style="width:50px;">No</th>
            <th>폼 제목</th>
            <th style="width:160px;">테이블명</th>
...
<div class="page" id="page-customInquiryDetail">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group" style="margin-bottom:16px;">
          ...
          <div style="display:flex;gap:20px;margin-top:6px;">
            <label style="display:flex;align-items:center;gap:6px;cursor:pointer;font-weight:400;">
              <input type="radio" name="ci_is_active" value="1"/> 사용
            </label>
            <label style="display:flex;align-items:center;gap:6px;cursor:pointer;font-weight:400;">
              <input type="radio" name="ci_is_active" value="0"/> 미사용
            </label>
          </div>
        </div>
        ...
        <div class="ci-feature-row">
          <div class="ci-feature-label">
            <label class="ci-toggle-wrap">
              <input type="checkbox" id="ci_period_use" onchange="ciToggleFeature('period')"/>
        ...
        <div class="ci-feature-row">
          <div class="ci-feature-label">
            <label class="ci-toggle-wrap">
              <input type="checkbox" id="ci_login_use" onchange="ciToggleFeature('login')"/>
              <span class="ci-toggle"></span>
            </label>
            <span>로그인 연동</span>
          </div>
        ...
        <div class="ci-feature-row">
          <div class="ci-feature-label">
            <label class="ci-toggle-wrap">
              <input type="checkbox" id="ci_visibility_use" onchange="ciToggleFeature('visibility')"/>
              <span class="ci-toggle"></span>
            </label>
            <span>공개글 여부</span>
          </div>
        ...
        <div class="ci-feature-row">
          <div class="ci-feature-label">
            <label class="ci-toggle-wrap">
              <input type="checkbox" id="ci_comment_use" onchange="ciToggleFeature('comment')"/>
              <span class="ci-toggle"></span>
            </label>
            <span>댓글</span>
          </div>
        ...
        <div class="ci-feature-row">
          <div class="ci-feature-label">
            <label class="ci-toggle-wrap">
              <input type="checkbox" id="ci_product_use" onchange="ciToggleFeature('product')"/>
              <span class="ci-toggle"></span>
            </label>
            <span>제품선택</span>
          </div>
  ...
  <div class="ci-tab-panel" id="ci-panel-managers">
    <div class="card">
      <div class="card-header" style="display:flex;justify-content:space-between;align-items:center;">
        <h3>담당관리자 목록</h3>
        <button class="btn btn-primary btn-sm" onclick="ciOpenManagerModal()">+ 담당자 추가</button>
      </div>
      <div class="card-body" style="padding:0;">
        <table class="data-table" id="ciManagerTable">
          <thead>
            <tr>
              <th>이름</th>
              <th>담당부서</th>
    ...
    <div class="card" style="margin-top:16px;">
      <div class="card-header"><h3>담당자 변경 히스토리</h3></div>
      <div class="card-body" style="padding:0;">
        <table class="data-table" id="ciManagerHistoryTable">
          <thead>
            <tr>
  ...
  <div class="ci-tab-panel" id="ci-panel-status">
    <div class="card">
      <div class="card-header" style="display:flex;justify-content:space-between;align-items:center;">
        <h3>상태 항목</h3>
        <button class="btn btn-primary btn-sm" onclick="ciAddStatusRow()">+ 상태 추가</button>
      </div>
      <div class="card-body">
    ...
    <div class="card">
      <div class="card-body">
        <div class="form-group" style="margin-bottom:16px;">
          ...
          <div style="display:flex;gap:20px;margin-top:6px;">
            <label style="display:flex;align-items:center;gap:6px;cursor:pointer;font-weight:400;">
              <input type="radio" name="ci_reply_use" value="1" onchange="ciToggleReply()"/> 사용
            </label>
            <label style="display:flex;align-items:center;gap:6px;cursor:pointer;font-weight:400;">
              <input type="radio" name="ci_reply_use" value="0" onchange="ciToggleReply()" checked/> 미사용
            </label>
          </div>
        </div>
        <div id="ci-reply-method-wrap" style="display:none;">
          <div class="form-group" style="margin-bottom:16px;">
            ...
            <div style="display:flex;gap:20px;margin-top:6px;">
              <label style="display:flex;align-items:center;gap:6px;cursor:pointer;font-weight:400;">
                <input type="radio" name="ci_reply_method" value="email"/> 이메일
              </label>
              <label style="display:flex;align-items:center;gap:6px;cursor:pointer;font-weight:400;">
                <input type="radio" name="ci_reply_method" value="alimtalk"/> 알림톡
              </label>
              <label style="display:flex;align-items:center;gap:6px;cursor:pointer;font-weight:400;">
                <input type="radio" name="ci_reply_method" value="sms"/> 문자(SMS)
              </label>
            </div>
          </div>
          <div class="ci-info-box" style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:14px 16px;font-size:.83rem;color:#1e40af;line-height:1.7;">
            ※ 이메일 선택 시 <strong>이메일 필드</strong>와 <strong>연락처 필드</strong>가 필수로 생성됩니다.<br>
  ...
  <div class="ci-tab-panel" id="ci-panel-fields">
    <div class="card">
      <div class="card-header" style="display:flex;justify-content:space-between;align-items:center;">
        <h3>필드 설정</h3>
        <button class="btn btn-primary btn-sm" onclick="ciOpenFieldModal()">+ 필드 추가</button>
      </div>
      <div class="card-body">
        <!-- 고정 필드 -->
        <div style="margin-bottom:20px;">
          ...
          <div style="display:flex;gap:8px;flex-wrap:wrap;">
            <span class="badge" style="background:#e2e8f0;color:#475569;padding:6px 12px;border-radius:6px;">제목</span>
            <span class="badge" style="background:#e2e8f0;color:#475569;padding:6px 12px;border-radius:6px;">신청일시</span>
            <span class="badge" style="background:#e2e8f0;color:#475569;padding:6px 12px;border-radius:6px;">수정일시</span>
            <span class="badge" style="background:#e2e8f0;color:#475569;padding:6px 12px;border-radius:6px;">조회수</span>
            <span class="badge" style="background:#e2e8f0;color:#475569;padding:6px 12px;border-radius:6px;">상태</span>
          </div>
        </div>
        <!-- 선택 필드 목록 -->
  ...
  <div class="ci-tab-panel" id="ci-panel-terms">
    <div class="card">
      <div class="card-header" style="display:flex;justify-content:space-between;align-items:center;">
        <h3>약관 목록</h3>
        <button class="btn btn-primary btn-sm" onclick="ciOpenTermModal()">+ 약관 추가</button>
      </div>
      <div class="card-body" style="padding:0;">
        <table class="data-table" id="ciTermsTable">
          <thead>
            <tr>
    ...
    <div class="card-body" style="padding:16px 20px;">
      <div style="display:flex;gap:10px;flex-wrap:wrap;align-items:flex-end;">
        <div style="flex:1;min-width:160px;">
          <label style="font-size:.8rem;color:#64748b;display:block;margin-bottom:4px;">검색어</label>
          <input type="text" class="form-control" id="ciDataSearchKeyword" placeholder="제목 검색" onkeydown="if(event.key==='Enter')ciLoadData()"/>
        </div>
        <div style="min-width:120px;">
          <label style="font-size:.8rem;color:#64748b;display:block;margin-bottom:4px;">상태</label>
          <select class="form-control" id="ciDataSearchStatus">
            <option value="">전체</option>
          </select>
        </div>
        <div style="min-width:140px;">
          <label style="font-size:.8rem;color:#64748b;display:block;margin-bottom:4px;">시작일</label>
          <input type="date" class="form-control" id="ciDataSearchFrom"/>
        </div>
        <div style="min-width:140px;">
          <label style="font-size:.8rem;color:#64748b;display:block;margin-bottom:4px;">종료일</label>
          <input type="date" class="form-control" id="ciDataSearchTo"/>
        </div>
        <button class="btn btn-primary" onclick="ciLoadData()">검색</button>
        <button class="btn btn-outline" onclick="ciResetSearch()">초기화</button>
      </div>
    </div>
  </div>
  <div class="card">
    <div class="card-body" style="padding:0;">
      <table class="data-table" id="ciDataTable">
        <thead id="ciDataTableHead">
          <tr>
            <th style="width:50px;">No</th>
            <th>제목</th>
    ...
    <div class="card-footer" id="ciDataPagination" style="display:flex;gap:6px;justify-content:center;padding:16px;"></div>
  </div>
</div>
